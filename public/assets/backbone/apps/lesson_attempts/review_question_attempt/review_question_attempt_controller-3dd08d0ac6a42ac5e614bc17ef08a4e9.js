...
(function() {
  ...
  this.LanguageLesson.module("LessonAttemptsApp.ReviewQuestionAttempt", function(ReviewQuestionAttempt, App, Backbone, Marionette, $, _) {
    return ReviewQuestionAttempt.Controller = (function(_super) {
      ...
      Controller.prototype.review = function(question_attempt) {
        console.log(question_attempt);
        this.respondView = this.getRespondView(question_attempt);
        return App.dialogRegion.show(this.respondView);
      };

      Controller.prototype.getRespondView = function(question_attempt) {
        return new ReviewQuestionAttempt.Respond({
