...
(function() {
  ...
  this.LanguageLesson.module("LessonAttemptsApp.ReviewQuestionAttempt", function(ReviewQuestionAttempt, App, Backbone, Marionette, $, _) {
    return ReviewQuestionAttempt.Respond = (function(_super) {
      __extends(Respond, _super);

      function Respond() {
        return Respond.__super__.constructor.apply(this, arguments);
      }

      Respond.prototype.template = "lesson_attempts/review_question_attempt/templates/respond";

      Respond.prototype.dialog = function() {
        return {
          title: this.getTitle()
        };
      };

      Respond.prototype.getTitle = function() {
        return 'foo';
      };

      Respond.prototype.templateHelpers = function() {};

      Respond.prototype.onShow = function() {
      ...
      Respond.prototype.onRender = function() {
        return console.log('onRender');
      };

      Respond.prototype.showRecording = function(url) {
        var container;
        ...
        this.wavesurfer.on('loading', function(something) {
