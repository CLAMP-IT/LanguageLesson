...
(function() {
  ...
  this.LanguageLesson.module("LessonsApp.Show", function(Show, App, Backbone, Marionette, $, _) {
    return Show.PromptedAudioQuestionElement = (function(_super) {
      ...
      PromptedAudioQuestionElement.prototype.template = 'lessons/show/templates/_prompted_audio_question';
