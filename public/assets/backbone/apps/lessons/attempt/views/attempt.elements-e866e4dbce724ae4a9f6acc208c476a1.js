(function() {
  ...
  this.LanguageLesson.module("LessonsApp.Attempt", function(Attempt, App, Backbone, Marionette, $, _) {
    return Attempt.Elements = (function(_super) {
      ...
      Elements.prototype.template = "lessons/attempt/templates/elements_collection";
      ...
      Elements.prototype.onShow = function() {
        return $("#element_count").html("" + (this.currentView + 1) + " of " + this.model.elements.length);
      };
