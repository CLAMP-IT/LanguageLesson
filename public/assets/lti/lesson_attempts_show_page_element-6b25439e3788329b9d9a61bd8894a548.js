...
(function() {
  $(function() {
    var analyser, audio_context, createDownloadLink, createUploadLink, recorder, startUserMedia, __log;
    ...
    createDownloadLink = function() {
      return recorder && recorder.exportWAV((function(_this) {
        return function(blob) {
          ...
          return RecordingApp.uploadFile(blob);
        };
      })(this));
    };
